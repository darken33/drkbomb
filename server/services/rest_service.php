...
// On insere le score
$requete="INSERT INTO drkbomb_score (`id` ,`name` ,`passe` ,`duree` ,`score` ,`difficulty`) VALUES (NULL , '".$name."', '".$passe."', '".$time."', '".$score."', '".$difficulty."');";
$result=mysql_query($requete);
$idrow=mysql_insert_id(); 

// On recupère les 10 meilleurs scores
$requete="SELECT `id`, `name`, `passe`, `duree`, `score`, `difficulty` FROM drkbomb_score WHERE `difficulty` = '".$difficulty."' ORDER BY score DESC, duree DESC;";
$result=mysql_query($requete);
